...
const dcrypto = {
  ...
  sha512: hash.sha512,
  vrf_algo_prove: hash.vrf_algo_prove,
  vrf_algo_verify: hash.vrf_algo_verify,
  vrf_algo_keypair: hash.vrf_algo_keypair,
  vrf_algo_proof_to_hash: hash.vrf_algo_proof_to_hash,
